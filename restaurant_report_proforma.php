...
?>
	...
	<table width="100%">
    	...
    	<tr style="<?php echo $col; ?>">
    		...
    		<td><a href="restaurant_proforma.php?e_id=<?php echo $row['sno']; ?>" target="_blank"><i class="fas fa-edit"></i></a></td>
    		<td><a href="restaurant_print_proforma.php?id=<?php echo $row['sno']; ?>" target="_blank">Print</a></td>
...
function submitExportExcel(event) {
    ...
    form.action = 'restproforma_report_export.php';
    form.submit();
    return false;
}
</script>
