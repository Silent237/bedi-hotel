...
$("input#cust_name1").on("keydown.autocomplete", function() {
 ...
 <div id="container">
	...
	<form action="" class="wufoo leftLabel page1" id="report_allotment" name="addnewdesignation" enctype="multipart/form-data" method="post" onSubmit="" >
		...
		<table>
			<tr  class="no-print">
				<td colspan="25" float="center" class="text-center">
				<a href="room_bill_summery_export.php"><input type="button" style=" background-color: #f44f4f; color:white;width:200px;" name="student_ledger" class="form-control btn btn-danger"  style="float: left;" value="Download In Excel"></a></span>
				</td>
			</tr>
			<tr>
				<th  <?php echo $rowspan; ?>>S.No.</th>
				<th  <?php echo $rowspan; ?>>Room No.Guest Name</th>
				<th  <?php echo $rowspan; ?>>Invoice No.</th>
				<th  <?php echo $rowspan; ?>>Room Rent</th>
				<th  <?php echo $rowspan; ?>>Extra Bed</th>
				<th  <?php echo $rowspan; ?>>Disc.
				<th  <?php echo $rowspan; ?>>Taxable Price</th>
				<th  <?php echo $rowspan; ?>>SGST</th>
				<th  <?php echo $rowspan; ?>>CGST</th>
				<th  <?php echo $rowspan; ?>>IGS
				...
				<th  <?php echo $rowspan; ?> class="no-print"></th>
				<th  <?php echo $rowspan; ?> class="no-print"></th>
				<th  <?php echo $rowspan; ?> class="no-print">E-Inv</th>
			</tr>
