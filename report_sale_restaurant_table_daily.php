...
function edit_mode_of_payment(id){
    ...
    <div id="container">
        ...
        <h2>Daily Restaurant Summary</h2>
...
function submitExportExcel(event) {
    ...
    form.action = 'restable_daily_report_export.php';
    form.submit();
    return false;
}
</script>
