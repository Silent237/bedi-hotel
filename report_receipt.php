 ...
 <div id="container">
    ...
    <?php
				...
				foreach($result as $row)
				{
					...
					<td>'.$row['amount'].'</td>
					<td>'.$row['timestamp'].'</td>
					<td class="no-print"><a href="receipts.php?id='.$row['sno'].'"><i class="fas fa-edit"></i></a></td>
					<td class="no-print"><a href="report_receipt.php?del='.$row['sno'].'" onclick="return confirm(\'Are you sure?\');"><i class="fas fa-trash-alt" style="color:red;"></i></a></td>
					</tr>';
				}
